...
// configuration step. It creates a namespace called `Scan`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", Scan::cmake::project_name, Scan::cmake::project_version) };
